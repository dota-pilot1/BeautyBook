...
## 한줄 요약
ai 개발에 대해 완전 자동화 , 미래의 agi 를 기대하는건 부당 애시 당초 그건 사람도 할수 없음 c, c++ 가 어셈블리에 대한 추상화 계층인것처럼 
스프링 프레임 워크가 객체 지향에 대한 기능의 관례적 집합이라면 ai agent는 설계 위에서 동작하는 자연어 기반 구현 프레임워크