      ...
      <main className="w-full px-4 py-4">
        ...
        <section className="mb-5 grid gap-3 border-y border-border bg-muted/25 py-3 text-sm md:grid-cols-3">
          <div className="px-1">
            ...
            <p className="mt-1 text-xs text-muted-foreground">예약, 시술, 매출 기능별 권한 코드를 먼저 등록합니다.</p>
          </div>
          <div className="px-1">
            <p className="font-semibold">2. 롤 구성</p>
            <p className="mt-1 text-xs text-muted-foreground">권한 묶음을 관리자, 매니저, 스타일리스트 롤에 연결합니다.</p>
          </div>
          <div className="px-1">
            <p className="font-semibold">3. 유저 배정</p>
            <p className="mt-1 text-xs text-muted-foreground">직원과 고객에게 필요한 롤만 부여합니다.</p>
          </div>
        </section>
