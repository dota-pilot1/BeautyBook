...
function AdminDropdown() {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute left-0 top-full mt-2 w-36 rounded-lg border border-border bg-background shadow-lg z-50 py-1 overflow-hidden">
          <Link
            href="/users"
      ...
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          {status === "authenticated" ? (
            <>
              {/* User info pill */}
              <div className="hidden sm:flex items-center gap-2 rounded-full border border-border/60 bg-muted/50 px-3 py-1.5">
